...
var OperatorDeploy = &appsv1.Deployment{
	...
	Spec: appsv1.DeploymentSpec{
		Replicas: P(int32(1)),
		Selector: &metav1.LabelSelector{MatchLabels: map[string]string{"app": "keda-operator"}},
				...
				Containers: []corev1.Container{
					{
						...
						Image:           "ghcr.io/kedacore/keda:2.11.1",
...
var OperatorMetricsApiserverDeploy = &appsv1.Deployment{
	...
	Spec: appsv1.DeploymentSpec{
		Replicas: P(int32(1)),
		Selector: &metav1.LabelSelector{MatchLabels: map[string]string{"app": "keda-operator-metrics-apiserver"}},
		Template: corev1.PodTemplateSpec{
			ObjectMeta: metav1.ObjectMeta{
				Labels: map[string]string{
					"app":                          "keda-operator-metrics-apiserver",
				...
				Containers: []corev1.Container{
					{
						...
						Image:           "ghcr.io/kedacore/keda-metrics-apiserver:2.11.1",
						ImagePullPolicy: corev1.PullPolicy("Always"),
						LivenessProbe: &corev1.Probe{
