...
var VictoriaMetricsOperatorCR = &rbacv1.ClusterRole{
	...
	Rules: []rbacv1.PolicyRule{{
		...
		APIGroups: []string{""},
		Resources: []string{"persistentvolumeclaims", "persistentvolumeclaims/finalizers"},
		Verbs:     []string{"*"},
	}, {
		APIGroups: []string{""},
		...
		APIGroups: []string{"apps"},
		Resources: []string{"statefulsets", "statefulsets/finalizers", "statefulsets/status"},
		Verbs:     []string{"*"},
	}, {
		...
		APIGroups: []string{"operator.victoriametrics.com"},
		Resources: []string{"vmalertmanagers", "vmalertmanagers/finalizers"},
		Verbs:     []string{"create", "delete", "get", "list", "patch", "update", "watch"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		APIGroups: []string{"operator.victoriametrics.com"},
		Resources: []string{"vmalertmanagerconfigs", "vmalertmanagerconfigs/finalizers"},
		Verbs:     []string{"create", "delete", "get", "list", "patch", "update", "watch"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		APIGroups: []string{"operator.victoriametrics.com"},
		Resources: []string{"vmservicescrapes", "vmservicescrapes/finalizers"},
		Verbs:     []string{"create", "delete", "get", "list", "patch", "update", "watch"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		APIGroups: []string{""},
		Resources: []string{"nodes", "nodes/proxy", "services", "endpoints", "pods", "endpointslices", "configmaps", "nodes/metrics", "namespaces"},
		Verbs:     []string{"get", "list", "watch"},
	}, {
		...
		Resources: []string{"clusterrolebindings", "clusterrolebindings/finalizers", "clusterroles", "clusterroles/finalizers", "roles", "rolebindings"},
		Verbs:     []string{"get", "list", "create", "patch", "update", "watch", "delete"},
	}, {
		APIGroups: []string{"policy"},
		Resources: []string{"podsecuritypolicies", "podsecuritypolicies/finalizers"},
		Verbs:     []string{"get", "list", "create", "patch", "update", "use", "watch", "delete"},
	}, {
		APIGroups: []string{""},
		Resources: []string{"serviceaccounts", "serviceaccounts/finalizers"},
		Verbs:     []string{"get", "list", "create", "watch", "update", "delete"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		APIGroups: []string{"operator.victoriametrics.com"},
		Resources: []string{"vmstaticscrapes", "vmstaticscrapes/finalizers"},
		Verbs:     []string{"create", "delete", "get", "list", "patch", "update", "watch"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		APIGroups: []string{"operator.victoriametrics.com"},
		Resources: []string{"vmauths", "vmauths/finalizers", "vmusers", "vmusers/finalizers"},
		Verbs:     []string{"create", "delete", "get", "list", "patch", "update", "watch"},
	}, {
		APIGroups: []string{"operator.victoriametrics.com"},
		...
		Verbs:     []string{"list", "get", "delete", "create", "update", "watch"},
	}, {
