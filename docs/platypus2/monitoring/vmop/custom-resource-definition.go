...
var VmnodescrapesOperatorVictoriametricsComCRD = &apiextensionsv1.CustomResourceDefinition{
	ObjectMeta: metav1.ObjectMeta{
		Annotations: map[string]string{"controller-gen.kubebuilder.io/version": "v0.10.0"},
...
var VmservicescrapesOperatorVictoriametricsComCRD = &apiextensionsv1.CustomResourceDefinition{
	ObjectMeta: metav1.ObjectMeta{
		Annotations: map[string]string{"controller-gen.kubebuilder.io/version": "v0.10.0"},
					...
					"spec": {
						...
						Properties: map[string]apiextensionsv1.JSONSchemaProps{
							"discoveryRole": {
								...
								Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"endpoints\"")}, {Raw: []byte("\"service\"")}, {Raw: []byte("\"endpointslices\"")}},
								Type:        "string",
							},
							"endpoints": {
